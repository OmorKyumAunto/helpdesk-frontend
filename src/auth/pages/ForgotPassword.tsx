  ...
  return (
    <>
      ...
      >
        ...
        >
          <path
            fill="#3B82F6" // Corrected from invalid #5684f8ff to match Login
              ...
              <Form name="login-form" layout="vertical" onFinish={onFinish}>
                <Row gutter={[6, 8]}> {/* Adjusted gutter to match Login */}
                  <Col xs={24}>
                    <Form.Item
                      name="email"
                      label={<span style={{ fontWeight: 500, color: "#1E40AF" }}>Email</span>} // Matched Login label style
                      rules={[
                        {
                          type: "email",
                    ...
                    >
                      <Input
                        ...
                        prefix={<MailOutlined style={{ color: "#60A5FA" }} />} // Matched Login icon color
                    ...
                    <Form.Item>
                      <div style={{ display: "flex", justifyContent: "center" }}>
                        <SubmitButton
                          loading={isLoading}
                          label="Send OTP"
                          icon={<MailOutlined />} // Added icon to match Login's button style
                          style={{
                            width: "100%",
                            background: "#3B82F6",
                            color: "#fff",
