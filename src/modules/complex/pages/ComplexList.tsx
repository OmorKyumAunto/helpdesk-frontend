...
import { useGetComplexesQuery } from "../api/complexEndPoint";
import { ComplexTableColumns } from "../utils/ComplexTableColumns";
...
const ComplexList = () => {
  ...
  const [filter, setFilter] = useState<IComplexParams>({
  ...
  const { data, isLoading, isFetching } = useGetComplexesQuery({ ...filter });
          ...
          >
            ...
            <CreateButton
              ...
              onClick={() => {
                dispatch(
                  setCommonModal({
                    title: "Create Complex",
                    content: <CreateComplex />,
                    show: true,
                    width: 500,
                  })
                );
