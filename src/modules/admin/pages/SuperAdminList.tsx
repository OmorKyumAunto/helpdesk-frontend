...
import { useGetUnitSuperAdminListQuery } from "../api/adminEndPoint";
import { IAdminParams } from "../types/adminTypes";
import { SuperAdminTableColumns } from "../utils/SuperAdminTableColumns";
const { Option } = Select;
...
const SuperAdminList = () => {
  ...
  const { data, isLoading, isFetching } = useGetUnitSuperAdminListQuery({ ...filter });
