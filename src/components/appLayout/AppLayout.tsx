...
const professionalStyles = {
  ...
  headerButton: {
    ...
    // Add the following for hover effect:
...
export const AppLayout = () => {
  ...
  const [sidebarWidth, setSidebarWidth] = useState(240); // Reduced from 280
  ...
  const handleClick: MenuProps["onClick"] = (e) => {
    // Force re-render by resetting and re-setting selection
    setCurrentSelection(""); // temporarily clear
    setTimeout(() => {
      setCurrentSelection(e.key);
    }, 0); // re-apply in next tick
  };
  ...
  useEffect(() => {
    const indices = findObjectWithKey(
      memoizedMenuItems as DataObject[],
      {
    ...
    <div style={{ minWidth: '180px' }}>
      <div style={{ padding: '12px', borderBottom: '1px solid #f3f4f6' }}>
        <Space direction="vertical" size={2}>
          <Text strong style={{ fontSize: '13px' }}>{profile?.data?.name}</Text>
          <Text type="secondary" style={{ fontSize: '11px' }}>
            {profile?.data?.email}
          </Text>
        </Space>
      </div>
      <Menu style={{ border: 'none', fontSize: '13px' }}>
  ...
  return (
    <Layout style={{ minHeight: "100vh", background: '#f8fafc' }}>
      ...
      >
        ...
        {/* Compact User Section with hover effects */}
        {!collapsed && profile?.data && (
          <div
            ...
            onMouseLeave={(e) => {
              ...
              e.currentTarget.style.background = 'linear-gradient(135deg, #f1f5f9 0%, #f8fafc 100%)';
            }}
          >
            <Space align="center" size={12}>
              ...
              <div>
                ...
                >
                  {roleId === 1
                    ? <span><span style={{ position: 'relative', top: '-1.5px' }}>👑</span> Super Admin</span>
                    : roleId === 2
                      ? '⚡ Admin'
                      : roleId === 3
                        ? '👤 User'
            ...
            <Space size={8} align="center">
              ...
              <Dropdown overlay={helpMenu} trigger={['click']} placement="bottomRight">
                <Tooltip title="Help & Documentation">
                  <Button
                    icon={<FaBookOpen color="#2a3b4f" size={18}/>} // Blue
                    style={professionalStyles.headerButton}
                    size="large"
                    onMouseEnter={e => e.currentTarget.style.transform = professionalStyles.headerButtonHover.transform}
              ...
              <Tooltip title="Video Tutorials">
                <Button
                  icon={<PiYoutubeLogoFill color="#FF0000" size={24} />} // YouTube Red
                  style={professionalStyles.headerButton}
                  size="large"
                  onClick={() =>
                    window.open(
              ...
              >
                <Button
                  ...
                  onMouseEnter={(e) => {
                    Object.assign(e.currentTarget.style, professionalStyles.profileButtonHover);
                  }}
                  onMouseLeave={(e) => {
                    Object.assign(e.currentTarget.style, professionalStyles.profileButton);
                  }}
                >
                  <Avatar
                    size={20}
